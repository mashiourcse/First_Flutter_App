    ...
    content: Padding(
      ...
      mainAxisAlignment: MainAxisAlignment.start,
        ...
        children: <Widget>[
          ...
          Container(
             child: Image.asset(Sayem.img_str),
        ),
            ...
            text: TextSpan(
             // text: 'Hello ',
              ...
              children: <TextSpan>[
                ...
                TextSpan(text: Sayem.playerRole),
              ],
            ),
          )
              ...
              child: RichText(
                text: TextSpan(
                  ...
                  children: <TextSpan>[
                    ...
                    TextSpan(text: Sayem.achievement),
                  ],
                ),
              )
              ...
              child: RichText(
                text: TextSpan(
                  ...
                  children: <TextSpan>[
                    ...
                    TextSpan(text: Sayem.curLevel.toString()),
                  ],
                ),
              )
